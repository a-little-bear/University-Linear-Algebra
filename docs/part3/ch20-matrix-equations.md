...
****：Sylvester 方程刻画了两个不同算子间的线性干涉，其谱分离条件揭示了系统共振与否的本质。

****：Lyapunov 方程通过二次型矩阵建立了代数与解析稳定性的桥梁，是控制工程中 Lyapunov 第二方法的算子表达。

****：Riccati 方程展示了非线性结构如何自然地出现在变分和最优控制问题中，其求解标志着从线性系统分析到线性系统综合的跨越。
